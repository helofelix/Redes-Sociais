const url = 'https://raw.githubusercontent.com/guilhermeonrails/api/main/dados-globais.json&#3';
...
*100)
 ...
 pessoasNoMundo) *100).toFixed(2)
   ...
   <br> Isso significa que aproximadamente <span>${porcentagemConectada}
